...
| 14 | `IMPLEMENTATION` | skill | `express-implementor` | `implementation_report` |
...
| 18 | `PR_REVIEW` | skill | `pr-reviewer` | `pr_review` |
| 19 | `HUMAN_PR_APPROVAL` | human gate | human | — |
| 20 | `PR_PREPARATION` | skill | `pr-preparer` | `pr_summary` |
| 21 | `READY_FOR_PR` | human gate | human | — |
| 22 | `COMPLETED` | human gate | human | — |
| 23 | `ARCHIVED` | terminal | `story-orchestrator` | `delivery_summary` |
